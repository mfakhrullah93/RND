...
var file_protos_accounting_service_proto_rawDesc = []byte{
	...
	0x0b, 0x32, 0x12, 0x2e, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x69, 0x6e, 0x67, 0x2e, 0x4c,
	0x65, 0x64, 0x67, 0x65, 0x72, 0x52, 0x07, 0x65, 0x6e, 0x74, 0x72, 0x69, 0x65, 0x73, 0x22, 0x7f,
	0x0a, 0x06, 0x4c, 0x65, 0x64, 0x67, 0x65, 0x72, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x17, 0x0a, 0x07, 0x74, 0x79, 0x70, 0x65,
	...
	0x61, 0x74, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x64, 0x61, 0x74, 0x65, 0x32,
...
var file_protos_accounting_service_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_protos_accounting_service_proto_goTypes = []any{
	...
	(*Ledger)(nil),                    // 6: accounting.Ledger
}
var file_protos_accounting_service_proto_depIdxs = []int32{
	6, // 0: accounting.GetLedgerEntryResponse.ledger:type_name -> accounting.Ledger
	6, // 1: accounting.ListLedgerEntriesResponse.entries:type_name -> accounting.Ledger
	0, // 2: accounting.AccountingService.CreateLedgerEntry:input_type -> accounting.CreateLedgerEntryRequest
	2, // 3: accounting.AccountingService.GetLedgerEntry:input_type -> accounting.GetLedgerEntryRequest
	4, // 4: accounting.AccountingService.ListLedgerEntries:input_type -> accounting.ListLedgerEntriesRequest
	1, // 5: accounting.AccountingService.CreateLedgerEntry:output_type -> accounting.CreateLedgerEntryResponse
	3, // 6: accounting.AccountingService.GetLedgerEntry:output_type -> accounting.GetLedgerEntryResponse
	5, // 7: accounting.AccountingService.ListLedgerEntries:output_type -> accounting.ListLedgerEntriesResponse
